...
import karachi from '@/public/images/jobs_in_karachi.png';

export default function JobsInKarachiPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* H1 */}
      <h1 className="text-3xl md:text-4xl font-bold text-center text-blue-600 mb-6">
        Jobs in Karachi – Latest Government & Private Vacancies
      </h1>
      ...
      <div className="flex justify-center mt-6 mb-6">
        <Image
          src={karachi}
          alt="Jobs in Karachi by HR Posting Partner"
      ...
      <div className="mx-auto max-w-3xl text-center space-y-4">
        <p className="text-lg text-gray-800">
          Searching for the latest jobs in Karachi? <strong>HR Posting Partner</strong> brings you
          ...
          <strong> sales</strong> or other fields, our portal makes job hunting in Karachi faster and easier.
        </p>
      </div>
      ...
      <section className="mx-auto max-w-3xl mt-10">
        ...
        <div className="rounded-2xl border p-6 text-center shadow-sm">
          ...
          <a
            ...
            aria-label="Join HR Posting Partner WhatsApp Channel for Karachi jobs"
          >
            WhatsApp Channel
          </a>
          <p className="mt-2 text-sm text-gray-600">
            This way, you stay updated on the latest Karachi jobs without checking the website every day.
          </p>
        </div>
      </section>

      {/* Classified Jobs in Karachi */}
      <section className="mx-auto max-w-3xl mt-12">
        <h2 className="text-2xl font-semibold text-gray-900 text-center mb-4">
          Explore Classified Jobs in Karachi
        </h2>
        <p className="text-gray-800 text-center mb-4">
          For quick access to fresh job ads, visit our <strong>Classified Jobs – Karachi</strong> section.
        </p>
        <ul className="list-disc pl-6 space-y-2 text-gray-800">
          <li>Daily updated job postings specific to Karachi.</li>
        ...
        <div className="text-center mt-6">
          <Link
            ...
            aria-label="Browse Classified Jobs in Karachi"
          >
            Browse Classified Jobs – Karachi
          </Link>
        </div>
      </section>
    </div>
